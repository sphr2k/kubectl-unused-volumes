...
func GetAllDeployment(clientSet *kubernetes.Clientset, namespace string) (workloads []api.Workload, err error) {
	workloadList, err := clientSet.AppsV1().Deployments(namespace).List(context.Background(), metaV1.ListOptions{})
	if err != nil {
		return
	}
...
func GetAllDaemonSet(clientSet *kubernetes.Clientset, namespace string) (workloads []api.Workload, err error) {
	workloadList, err := clientSet.AppsV1().DaemonSets(namespace).List(context.Background(), metaV1.ListOptions{})
	if err != nil {
		return
	}
...
func GetAllStatefulset(clientSet *kubernetes.Clientset, namespace string) (workloads []api.Workload, err error) {
	workloadList, err := clientSet.AppsV1().StatefulSets(namespace).List(context.Background(), metaV1.ListOptions{})
	if err != nil {
		return
	}
...
func GetAllJobs(clientSet *kubernetes.Clientset, namespace string) (workloads []api.Workload, err error) {
	workloadList, err := clientSet.BatchV1().Jobs(namespace).List(context.Background(), metaV1.ListOptions{})
	if err != nil {
		return
	}
